...
export type ExpenseRequestForEditQuery = { __typename?: 'Query', expenseRequest?: { __typename?: 'ExpenseRequest', id: number, amount: number, state: RequestState, description?: string | null, createdAt: string, account?: { __typename?: 'Account', id: string, name: string, code: string } | null, category?: { __typename?: 'Category', id: string, name: string, description?: string | null } | null, attachment: { __typename?: 'Attachment', id: number, s3Key: string, title: string, amount: number } } | null };
