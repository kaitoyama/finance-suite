...
export type CreateExpenseRequestInput = {
  ...
  amount: Scalars['Float']['input'];
  attachmentIds: Array<Scalars['Int']['input']>;
...
export type ExpenseRequestDetailQuery = { __typename?: 'Query', expenseRequest?: { __typename?: 'ExpenseRequest', id: number, amount: number, state: RequestState, createdAt: string, approvedAt?: string | null, description?: string | null, requester: { __typename?: 'User', id: string, username: string }, approver?: { __typename?: 'User', id: string, username: string } | null, attachments: Array<{ __typename?: 'Attachment', id: number, title: string, amount: number, createdAt: string, s3Key: string, uploader: { __typename?: 'User', id: string, username: string } }>, account?: { __typename?: 'Account', id: string, name: string, code: string } | null, category?: { __typename?: 'Category', id: string, name: string, description?: string | null } | null, payment?: { __typename?: 'Payment', id: number, amount: number, paidAt: string, method: PaymentMethod, label: PaymentLabel, direction: PaymentDirection, attachments?: Array<{ __typename?: 'Attachment', id: number, s3Key: string, title: string, amount: number, createdAt: string, uploader: { __typename?: 'User', id: string, username: string } } | null> | null } | null } | null };

export type ExpenseRequestForEditQueryVariables = Exact<{
  id: Scalars['Int']['input'];
}>;


export type ExpenseRequestForEditQuery = { __typename?: 'Query', expenseRequest?: { __typename?: 'ExpenseRequest', id: number, amount: number, state: RequestState, description?: string | null, createdAt: string, account?: { __typename?: 'Account', id: string, name: string, code: string } | null, category?: { __typename?: 'Category', id: string, name: string, description?: string | null } | null, attachments: Array<{ __typename?: 'Attachment', id: number, s3Key: string, title: string, amount: number }> } | null };

export type ExpenseRequestsListQueryVariables = Exact<{ [key: string]: never; }>;


export type ExpenseRequestsListQuery = { __typename?: 'Query', expenseRequests?: Array<{ __typename?: 'ExpenseRequest', id: number, amount: number, state: RequestState, createdAt: string, attachments: Array<{ __typename?: 'Attachment', id: number, title: string }>, requester: { __typename?: 'User', id: string, username: string } }> | null };
...
export type GetInvoiceByIdQuery = { __typename?: 'Query', invoice: { __typename?: 'Invoice', id: number, pdfKey: string, status: InvoiceStatus, amount: number, partnerName: string, description?: string | null, issueDate: string, dueDate: string, invoiceNo: string } };

export type GetInvoicesQueryVariables = Exact<{ [key: string]: never; }>;


export type GetInvoicesQuery = { __typename?: 'Query', invoices: Array<{ __typename?: 'Invoice', id: number, invoiceNo: string, partnerName: string, amount: number, status: InvoiceStatus, issueDate: string, dueDate: string, createdAt: string }> };
...
export type MarkExpensePaidMutation = { __typename?: 'Mutation', markExpensePaid: { __typename?: 'ExpenseRequest', id: number, state: RequestState } };

export type MeQueryVariables = Exact<{ [key: string]: never; }>;


export type MeQuery = { __typename?: 'Query', me: { __typename?: 'MeDto', username: string, isAdmin: boolean } };
...
export const ExpenseRequestForEditDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"ExpenseRequestForEdit"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"id"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"Int"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"expenseRequest"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"id"},"value":{"kind":"Variable","name":{"kind":"Name","value":"id"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"amount"}},{"kind":"Field","name":{"kind":"Name","value":"state"}},{"kind":"Field","name":{"kind":"Name","value":"description"}},{"kind":"Field","name":{"kind":"Name","value":"createdAt"}},{"kind":"Field","name":{"kind":"Name","value":"account"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"name"}},{"kind":"Field","name":{"kind":"Name","value":"code"}}]}},{"kind":"Field","name":{"kind":"Name","value":"category"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"name"}},{"kind":"Field","name":{"kind":"Name","value":"description"}}]}},{"kind":"Field","name":{"kind":"Name","value":"attachments"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"s3Key"}},{"kind":"Field","name":{"kind":"Name","value":"title"}},{"kind":"Field","name":{"kind":"Name","value":"amount"}}]}}]}}]}}]} as unknown as DocumentNode<ExpenseRequestForEditQuery, ExpenseRequestForEditQueryVariables>;
...
export const MarkExpensePaidDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"MarkExpensePaid"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"input"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"MarkExpensePaidInput"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"markExpensePaid"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"input"},"value":{"kind":"Variable","name":{"kind":"Name","value":"input"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"state"}}]}}]}}]} as unknown as DocumentNode<MarkExpensePaidMutation, MarkExpensePaidMutationVariables>;
