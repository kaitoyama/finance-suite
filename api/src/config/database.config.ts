...
export class DatabaseConfigService {
  ...
  getDatabaseUrl(): string {
    ...
    this.logger.log(
      `Database config - Host: ${host}, Port: ${port}, Database: ${database}, User: ${user}`,
    );
    this.logger.log(
      `Generated database URL: ${this.maskPassword(databaseUrl)}`,
    );
